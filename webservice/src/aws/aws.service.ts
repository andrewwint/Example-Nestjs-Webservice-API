...
export class AwsService {
  ...
  public instanances = undefined;

  /**
   * Description: Performs AWS EC2 `describeInstance` find all the instances with a specfic Tag key value pair
   *
   *              `aws ec2 describe-instances --filter 'Name=tag:StackName,Values=production-us-east-1-hillspet'`
   *
